...
export class SocialHistoryChildComponent implements OnInit {
    ...
    loadingImg: string = "assets/history/loading.jpg";
    ...
    getBackgroundPosition(): string {
        if (this.historyId === 0 || this.historyId === 3 || this.historyId === 8 || this.historyId === 18 || this.historyId === 19 || this.historyId === 28) {
            return 'center';
        } else if (this.historyId === 1 || this.historyId === 17 || this.historyId === 24 || this.historyId === 25) {
            return '60%';
        }
        else if (this.historyId === 2 || this.historyId === 6 || this.historyId === 12 || this.historyId === 14 || this.historyId === 16 || this.historyId === 23 || this.historyId === 27 || this.historyId === 29) {
            return '30%';
        }
        else if (this.historyId === 21 || this.historyId === 22 || this.historyId === 30) {
            return '40%';
        }
        ...
        else if (this.historyId === 11 || this.historyId === 5 || this.historyId === 7 || this.historyId === 20 || this.historyId === 26) {
            return '70%'
        }
